...
// Prepare the SQL statement to retrieve the employee data
...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        echo "Welcome " .$row['employee_first_name'] . ", Don't forget to clock in!";
        echo "<br><br><br><br><br>";
        echo "<li><strong>Employee ID:</strong> ".$row['employee_id']."</li>";
        echo "<li><strong>First Name:</strong> ".$row['employee_first_name']."</li>";
        echo "<li><strong>Last Name:</strong> ".$row['employee_last_name']."</li>";
